...
cocktails_hash =
{
  "I Am Sean Archer" =>
  {
    ...
    "user_image" => "https://bevvyco.s3.amazonaws.com/img/drinks/hy/bfhy/penicillin-2d142816380e1e79f377b3871781b479-lg.jpg"
  },
  "I Am Castor Troy" =>
  {
    "ingredients" => ["Lemonhart 151 Rum", "Cardamaro", "Fernet Branca", "Swedish Punsch", "soda"],
    "user_image" => "https://i.pinimg.com/originals/e0/5d/93/e05d936b38adc743e20d1abed6594953.jpg"
  },
  "I Could Eat a Peach For Hours" =>
  {
    "ingredients" => ["Old Granddad Bonded Bourbon", "Dolin Blanc Vermouth", "Creme de Peche", "honey", "lime juice", "angostura bitters"],
    "user_image" => "https://stripedspatula.com/wp-content/uploads/2018/08/bourbon-peach-smash-4-680x952.jpg"
  },
  "Golden Pistols" =>
  {
    "ingredients" => ["Sombra Mezcal", "Pineau de Charentes", "Pierre Ferrand Dry Curacao", "Plymouth Gin", "Campari", "Cane syrup"],
    "user_image" => "https://cdn.pastemagazine.com/www/articles/shade%20mezcal%20long.jpg"
  },
  "Doves At a Firefight" =>
  {
    "ingredients" => ["Byrrh", "Black Grouse Scotch", "Poire William eau de vie", "Peychaud's bitters", "long hot tincture"],
    "user_image" => "https://pbs.twimg.com/media/Dqs6mkHWwAIBFcs.jpg"
  },
  "Face Palm" =>
  {
    "ingredients" => ["A shot", "a beer"],
    "user_image" => "https://img.thedailybeast.com/image/upload/c_crop,d_placeholder_euli9k,h_1440,w_2559,x_0,y_0/dpr_1.5/c_limit,w_1044/fl_lossy,q_auto/v1507074391/171003-rothbuam-beer-shot-tease_vxnu3w"
  }
}
...
cocktails_hash.each do |key, value|
  cocktail = Cocktail.new(name: key)
